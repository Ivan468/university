  ...
  return (
    <>
      <body>
        ...
        >
          <div className="polygon-animate delay-1"></div>
          <div className="polygon-animate delay-2"></div>
          <div className="polygon-animate delay-3"></div>
          <div className="polygon-animate delay-4"></div>
          <div className="polygon-animate delay-5"></div>
          <div className="polygon-animate delay-6"></div>
          <div className="polygon-animate delay-7"></div>
          <div className="polygon-animate delay-8"></div>
          <div className="polygon-animate delay-9"></div>
          <div className="polygon-animate delay-10"></div>
          <div className="polygon-animate delay-11"></div>
          <div className="polygon-animate delay-12"></div>
          <div className="polygon-animate delay-13"></div>
          <div className="polygon-animate delay-14"></div>
          <div className="polygon-animate delay-15"></div>
          <div className="polygon-animate delay-16"></div>
          <div className="polygon-animate delay-1"></div>
          <div className="polygon-animate delay-2"></div>
          <div className="polygon-animate delay-3"></div>
          <div className="polygon-animate delay-4"></div>
	...
	C352.7,174.3,352.7,171.6,352.6,168.9z"
              ...
              <button className="btn-filials">Все филиалы</button>
            ...
            <div className="left-block right">
              <div className="retancle-one right">
                ...
                <div className="retancle-one-graph">
                  ...
                  <div
                    id="myearth"
                    className="earth-container earth-ready"
                  ></div>
