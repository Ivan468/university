  ...
  return (
    <div>
      <body>
        ...
        >
          <div class="polygon-animate delay-1"></div>
          <div class="polygon-animate delay-2"></div>
          <div class="polygon-animate delay-3"></div>
          <div class="polygon-animate delay-4"></div>
          <div class="polygon-animate delay-5"></div>
          <div class="polygon-animate delay-6"></div>
          <div class="polygon-animate delay-7"></div>
          <div class="polygon-animate delay-8"></div>
          <div class="polygon-animate delay-9"></div>
          <div class="polygon-animate delay-10"></div>
          <div class="polygon-animate delay-11"></div>
          <div class="polygon-animate delay-12"></div>
          <div class="polygon-animate delay-13"></div>
          <div class="polygon-animate delay-14"></div>
          <div class="polygon-animate delay-15"></div>
          <div class="polygon-animate delay-16"></div>
          <div class="polygon-animate delay-1"></div>
          <div class="polygon-animate delay-2"></div>
          <div class="polygon-animate delay-3"></div>
          <div class="polygon-animate delay-4"></div>
        ...
        <div class="content">
          ...
          <main>
            <div class="left-block">
              <div class="retancle-one">
                <div class="head-retancle">
                  <h3 class="finance-text">Финансы</h3>
                  <div class="finanse-cash">
                ...
                <div class="retancle-one-graph">
                  <div class="rotate-left">
                    <div>
                      <p>Севастопольський</p>
                      <div class="retalncle"></div>
                    </div>
                    <div>
                      <p>Тульский</p>
                      <div class="retalncle tulskiy-un"></div>
                    </div>
                    <div>
                      <p>Волгоградский</p>
                      <div class="retalncle volgradskiy-un"></div>
                    </div>
                    <div>
                      <p>Севастопольский</p>
                      <div class="retalncle sevastopolskiy-un"></div>
                    </div>
                    <div>
                      <p>Тульский</p>
                      <div class="retalncle tulskiy-un-two"></div>
                    </div>
                    <div>
                      <p>Севастопольский</p>
                      <div class="retalncle sevastopolskiy-un-two"></div>
                    </div>
                  </div>
                </div>
              </div>

              <div class="retancle-one bottom">
                <div class="head-retancle">
                  <h3 class="finance-text">Научная деятельность</h3>
                </div>
                <div class="retancle-one-graph">
                  <div class="column">
                    <div class="finanse-cash">
	...
	C352.7,174.3,352.7,171.6,352.6,168.9z"
              ...
              <button class="btn-filials">Все филиалы</button>
              <div class="budget">
              ...
              <div class="raiting-block">
                ...
                <div class="circle-text raiting-text">
                  <div>7.8</div>
                  <p>Рейтинг Вуза</p>
                </div>
              </div>
              <div class="publication-block">
                ...
                <div class="circle-text text-block">
                  <div>23</div>
                  <p>научные исследования</p>
                </div>
                <div class="circle-text text-block peocent-left">
                  <div>67%</div>
                  <p>Дневная форма</p>
                </div>
                <div class="circle-text text-block peocent-right">
                  <div>27%</div>
                  <p>Заочная форма</p>
                </div>
                <div class="circle-text text-block mid-text-circle">
                  <div>123</div>
                  <p>кол-во публикаций</p>
                </div>
                <div class="circle-text text-block bottom-text-circle">
                  <div>14</div>
              ...
              <div class="bottom-block">
                ...
                />
                <div class="circle-text raiting-text bottom-text-studetns">
                  <div>12 643</div>
              ...
              <div class="worker-block">
                ...
                <div class="circle-text worker-text">
                  <div>43</div>
                  <p>Принято сотрудников</p>
                </div>
                <div class="circle-text worker-text mid">
                  <div>9</div>
            ...
            <div class="left-block right">
              <div class="retancle-one right">
                <div class="head-retancle">
                  <h3 class="finance-text">Международная деятельность</h3>
                </div>
                <div class="retancle-one-graph">
                  <div class="globus">
                    <svg
                  ...
                  <div id="myearth" class="earth-container earth-ready"></div>

                  <div class="text-globus">
                    <div class="column">
                      <div class="finanse-cash">
                        <div class="one">9 504</div>
              ...
              <div class="retancle-one bottom right-bottom">
                <div class="head-retancle">
                  <h3 class="finance-text">Кадры</h3>
                </div>
                <div class="retancle-one-graph right-bottom">
          ...
          <div class="bottom-block-stats-wrapper">
            <div class="bottom-block-stats">
            ...
            <div class="left-wrapper">
              <div class="left--down-button button-down">
                <h3>Проверки</h3>
              </div>
              <div class="right--down-button button-down">
